...
export const serviceCards = [
  {
    ...
    offer: [
      "Brand Identity: The visual and verbal foundation of your brand. Logo systems, typography, color, and tone of voice built to be distinct, scalable, and unmistakably yours.",
      "Brand Foundation: defining the strategic core of your brand through purpose, positioning, and principles that give your business clear direction.",
      "Brand Systems: creating how your brand flexes across interfaces, formats, and platforms without losing coherence or consistency.",
      "Growth Strategy: identifying your next best customers, uncovering market opportunities, and positioning your brand to capture them.",
      "Visual Identity and Uniformity: Ensuring every touchpoint of your brand looks, feels, and speaks consistently.",
    ],
    benefits: ["Instant Recognition", "Strategic Clarity", "Scalable Consistency", "Market Positioning"],
    includes: [
      "Logo design and complete visual identity system",
      "Brand foundation, purpose and positioning document",
  ...
  },
  {
    ...
    offer: [
      "User Research: understanding how your users think, what they need, and where they drop off before a single screen is designed.",
      "Wireframing and Prototyping: mapping the full experience from rough structure to interactive prototype before committing to visuals.",
      "Figma Design: pixel precise, handoff ready design built in Figma with screens, components, and flows ready for development.",
      "Design Systems: a single source of truth for your product's visual language with consistent components and documented rules built to scale.",
      "Experience Design: designing the complete journey your user takes through your product.",
    ],
    benefits: ["Clean UI Development", "Reduced Drop Off", "Faster Development", "Product Consistency", "Informed Decisions"],
    includes: [
      "User research and journey mapping",
      "Wireframing and interactive Figma prototype",
  ...
  },
  {
    ...
    offer: [
      "SaaS Development: scalable web products built around real workflows, users, and business models.",
      "Mobile App Development: responsive app experiences designed and developed for smooth use across devices.",
      "Ecommerce Development: product, cart, and checkout experiences made to sell clearly.",
      "Custom Panels and Dashboards: internal tools, reporting panels, and admin systems that make operations easier.",
      "CMS Development: content-managed websites that teams can update without breaking the system.",
    ],
  ...
  },
  {
    ...
    image: "/images/current-site/ssPWxEkHTr79d4HxuYoqs7ZjLw.jpg",
    description:
      "We find the story at the centre of your brand and build content around it that connects with your audience, communicates your value clearly, and drives action across every platform and format.",
    ...
    offer: [
      "Brand Narrative: the words, ideas, and themes that make your brand easier to understand and remember.",
      "Website and Campaign Copywriting: structured copy that turns attention into action.",
      "Content Production: visuals, reels, campaign assets, and formats created for your brand context.",
      "Founder Storytelling: personal and company stories shaped for trust and credibility.",
      "Short Form and Long Form Content: assets built for social, web, campaigns, and launches.",
    ],
  ...
  },
  {
    ...
    image: "/images/current-site/DRX3VuxFWBAxL9unfWXmYaRaoIw.jpg",
    description:
      "We plan, launch, and optimise paid campaigns on Meta and Google that put your brand in front of the right people at the right time. Every rupee of your ad spend is tracked, tested, and worked as hard as possible.",
    capabilities: ["Meta Campaigns", "Google Ads", "Video Ads and Reels", "Digital Ad Creatives", "Product Photography and Videography"],
    offer: [
      "Meta Campaigns: campaign setup, testing, and optimisation for audience and offer fit.",
      "Google Ads: search and conversion campaigns built around intent.",
      "Video Ads and Reels: campaign videos made for attention and conversion.",
      "Digital Ad Creatives: static and motion assets for paid media.",
      "Product Photography and Videography: product-led assets for stronger campaign performance.",
    ],
  ...
  },
  {
    ...
    image: "/images/current-site/ssPWxEkHTr79d4HxuYoqs7ZjLw.jpg",
    description:
      "We build and manage your brand presence across social platforms with strategy, content, and community management that drive real engagement and measurable growth.",
    capabilities: ["Organic Strategy", "Content Creation", "Engagement and Community Management", "Visibility and Reach Growth", "Performance Reporting"],
    offer: [
      "Organic Strategy: content direction built around your audience and business goals.",
      "Content Creation: platform-ready visuals, reels, posts, and copy.",
      "Engagement and Community Management: daily systems for responding, listening, and growing trust.",
      "Visibility and Reach Growth: formats and campaigns built for discoverability.",
      "Performance Reporting: clear monthly reporting on what moved and why.",
    ],
...
export const projects = [
  {
    ...
    gallery: [
      "/images/current-site/5dPICNVskiIoFCUXZ8nPQsij8.png",
      "/images/current-site/1r2LGaCQOkbFk3UfEYBqSTrA0t0.jpg",
      "/images/current-site/bAtxuTMFQwMeze8ANnovodBgm3M.jpg",
      "/images/current-site/K72jNVDdKwDqbGplj2RlpIZU8.jpg",
    ],
    summary: "A complete brand launch built from initial idea to identity, content, and launch-ready digital presence.",
    scope: ["Brand Identity", "Launch Direction", "Content System", "Digital Presence"],
  },
  {
    ...
    summary: "A premium visual direction and brand experience system for a product-led business ready to feel sharper.",
    scope: ["Brand Direction", "Visual System", "Content Assets", "Premium Positioning"],
  },
  {
    ...
    gallery: [
      ...
      "/images/current-site/e9nHfLMFYg0FQzMPUpRRGxZhk.jpg",
      "/images/current-site/FthG9x2btuk94IJq9zqtxYpKnRk.jpg",
      "/images/current-site/bAtxuTMFQwMeze8ANnovodBgm3M.jpg",
    ],
    summary: "A visibility-first identity and content direction for an event company moving into a stronger regional position.",
    scope: ["Content Direction", "Social Media", "Regional Positioning", "Campaign Assets"],
  },
  {
    ...
    gallery: [
      ...
      "/images/current-site/9oEXc2YGPJEJd4JxqWt1oyyk39s.jpg",
      "/images/current-site/AfCgq7ylchnkqggodI3i7L05LE.jpg",
      "/images/current-site/jEOCbaXokbCXIqUiZHqmplJpZdY.jpg",
    ],
